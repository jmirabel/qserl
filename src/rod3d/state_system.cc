...
void
StateSystem::operator()(const state_type& i_q,
                        state_type& o_dqdt,
                        double i_t)
{
...
void
StateSystem::evaluateInextensible(const state_type& i_q,
                                  state_type& o_dqdt,
                                  double i_t)
{
...
void
StateSystem::evaluateExtensibleShearable(const state_type& i_q,
                                         state_type& o_dqdt,
                                         double i_t)
{
  const size_t k = static_cast<size_t>(i_t / m_dt);
